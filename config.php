...
$CONFIG['default']['base_url'] = 'http://preview.infovolunteer.com/';
$CONFIG['default']['root_path'] = $_SERVER['DOCUMENT_ROOT'].'/';

$CONFIG['default']['upload_path'] = $_SERVER['DOCUMENT_ROOT'].'/tmp/';
