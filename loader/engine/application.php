...
class Application {
	...
	function setPurifier()
	{
		...
		$filePath = CODEKIR_LIBS.'purifier/library/HTMLPurifier.auto.php';
	...
	function excel($file=false)
	{
		...
		$excelEngine = CODEKIR_LIBS . 'excel/excel_reader' . $CONFIG[$this->configkey]['php_ext'];
	...
	function loadSessi($param=null)
	{
		...
		$filename = CODEKIR_COREPATH.$param.$CONFIG[$this->configkey]['php_ext'];
