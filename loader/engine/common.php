...
function imageFrame($filename=false, $framefile=false)
{
	...
	if (array_key_exists('mobile',$CONFIG)) include(CODEKIR_LIBS.'class_image_upload/class.upload.php');
	else include(CODEKIR_LIBS.'class_image_upload/class.upload.php');
...
function sendGlobalMail($to,$from,$msg,$config=true){
	...
	require_once CODEKIR_LIBS."PHPMailer/class.phpmailer.php";
